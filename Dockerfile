...
ARG NEXT_PUBLIC_PRICING_SOURCE
ARG CMS_PUBLIC_REST_API_ENDPOINT
ARG NEXT_PUBLIC_SSO_URL
ARG NEXT_PUBLIC_THEME
ARG NEXT_PUBLIC_MODAL_FULL_WIDTH
...
ENV NEXT_PUBLIC_PRICING_SOURCE=$NEXT_PUBLIC_PRICING_SOURCE
...
ENV NEXT_PUBLIC_MODAL_FULL_WIDTH=$NEXT_PUBLIC_MODAL_FULL_WIDTH
