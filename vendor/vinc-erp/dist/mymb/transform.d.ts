import type { CustomerAddressAgent, CustomerPromo, MyMbErpSettings, MyMbPriceEntry, ProductLabelAction } from '../types/pricing.js';
...
export declare function buildCustomerAddressAgent(row: any): CustomerAddressAgent;
export {};
