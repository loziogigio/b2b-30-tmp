...
import { useProductQuery } from '@framework/product/get-hidros-product';
...
import ProductDetailsTab from '@components/product/product-details/product-tab-hidros';
import VariationPrice from './variation-price';
import isEqual from 'lodash/isEqual';
import { useTranslation } from 'src/app/i18n/client';

const ProductSingleDetailsHidros: React.FC<{ lang: string }> = ({ lang }) => {
...
export default ProductSingleDetailsHidros;
