        ...
        <TabPanels className="mt-6 lg:mt-9">
          <TabPanel className="lg:flex">
            <div className="text-sm sm:text-15px text-brand-muted leading-[2em] space-y-4 lg:space-y-5 xl:space-y-7">
              <p>
                Stufa a pellet ad aria da 7KW. Questa stufa è progettata per
                essere posizionata in ambienti piccoli: le dimensioni ridotte la
                rendono perfetta per tutti i tipi di abitazione. Il rivestimento
                in acciaio inox copre la struttura compatta della stufa, che si
                adatta perfettamente a qualsiasi stile di casa. Braciere in
                ghisa. Camera di combustione in acciaio. Capacità serbatoio
                pellet 11kg. Diametro uscita fumi Ø80mm. Telecomando (optional -
                disponibile su ordinazione). Possibilità di controllo remoto
                tramite Wi-Fi (optional - disponibile su ordinazione).
              </p>
            </div>
                ...
                <table className="w-full text-brand-dark text-15px">
                  <tbody>
                    <tr className="border-b border-border-four">
                      ...
                      <td className="border-s border-border-four px-4 py-3 lg:px-5 xl:px-6 text-right">
                        MIGNON6-B
                      </td>
                    </tr>
                    <tr className="border-b border-border-four">
